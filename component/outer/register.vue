<template>
  <div id="regbg">
      ...
      <div class="mydetailinfo">
          <span v-text="span[2]"></span> <input type="radio" value="0" name="gender" checked v-model="usergender"><i>男</i><input v-model="usergender" type="radio" value="1" name="gender"><i>女</i>
      </div>
      <div class="mydetailinfo">
      ...
      <div class="picture">
          <img class="weui-uploader__file" src="../../img/User.jpg"/>
      </div>
  </div>
</template>
<script>
...
.mydetailinfo  span,.mydetailinfo input,.mydetailinfo i{display:block;float: left;line-height: 70px;height:99%;}
